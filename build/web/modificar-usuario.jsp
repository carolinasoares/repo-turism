<%-- 
    ...
    Created on : 18/02/2020, 01:10:10
    Author     : Caro
--%>
        ...
        <div class="wrapper" style="">
                            ...
                            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                                <li class="nav-item has-treeview menu-open">
                                    ...
                                    <ul class="nav nav-treeview">
                                        <li class="nav-item">
                                            <a href="modificar-usuario.jsp" class="nav-link active">
            ...
            <div class="content-wrapper" style="padding: 30px;">
                ...
                <section class="content" style="padding: 70px;">
                    <div class="container" id="mensaje_mod_usuario" style="position: fixed; display: none;">
                        <div class="col-md-6 elevation-3" style=" height: 300px; background-color: #FBDAAD; margin-top: 200px; margin-left: 500px;">
                            <br> 
                            <button type="button" class="btn btn-primary boton" Style="margin-left: 90%;" onclick="$('#mensaje_mod_usuario').css('display','none'); window.location.reload();">&times;</button>
                            <br>
                            <h3 class="text-center titulo" style="padding-top: 30px;"><strong>Modificar Usuario</strong></h3>
                            <div class="row">
                                <div class="col-md-2"></div>
                                <div class="col-md-8">
                                    <p id="mje_mod_usu"></p>
                                    <button id="aceptar_mod_usuario" class="btn btn-primary btn-block boton" onclick="$('#mensaje_mod_usuario').css('display','none'); window.location.reload();">Aceptar</button>
                                    <br>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div id="card-modificar-usuario" class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Datos del Usuario</h3>
                                </div>
                                <form action="modificar-usuario" id="frm-modificar-usuario">
                                    <div class="card-body">
                                        <br>
                                        <div class="row">
                                            <div class="col-md-2"></div>
                                            <div class="col-md-8 form-group">
                                                <label for="modificar-usuario-actual">Usuario Actual:</label>
                                                <input type="text" class="form-control" name="usuario" id="modificar-usuario-actual" value="<%= request.getSession().getAttribute("nombre_usuario") %>" readonly/><br>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-2"></div>
                                            <div class="col-md-8 form-group">
                                                <label for="modificar-usuario-nuevo">Usuario Nuevo:</label>
                                                <input type="text" class="form-control" name="usuario_nuevo" id="modificar-usuario-nuevo" placeholder="Ingrese el nuevo usuario" maxlength="10" minlength="6" required/><br>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-2"></div>
                                            <div class="col-md-8 form-group">
                                                <label for="modificar-usuario-clave">Clave:</label>
                                                <input name="clave" id="modificar-usuario-clave" type="password" class="form-control" placeholder="Ingrese la cave actual" maxlength="8" minlength="6" required/><br>
                                            </div>
                                        </div>
                                    </div>
