<%-- 
    Document   : crear-reserva
    Created on : 16/02/2020, 15:02:09
    Author     : Caro
--%>
                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item has-treeview menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="obtener-crear-reserva" class="nav-link active">
                                          <i class="far fa-circle nav-icon"></i>
                                          <p>Crear Reservas</p>
                                        </a>
                                    </li>
            ...
            <div class="content-wrapper" style="padding: 30px;">
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0 text-dark">CREAR RESERVA</h1>
                            </div>
                            <div class="col-sm-6">
                ...
                <section class="content" style="padding: 70px;">
                    <div class="container" id="mensaje_crear_reserva" style="position: fixed; display: none;">
                        <div id="mensaje_crear_reserva_interno" class="container col-md-6 elevation-3" style=" height: 300px; background-color: #FBDAAD">
                            <br> 
                            <button type="button" class="btn btn-primary boton" Style="margin-left: 90%;" onclick="$('#mensaje_crear_reserva').css('display','none')">&times;</button>
                            <br>
                            <h3 class="text-center titulo" style="padding-top: 30px;"><strong>Crear Reserva</strong></h3>
                            <div class="row">
                                <div class="col-md-2"></div>
                                <div class="col-md-8">
                                    <p id="mje_crear_res"></p>
                                    <button id="aceptar_crear_res" class="btn btn-primary btn-block boton">Aceptar</button>
                                    <br>
                                </div>
                            </div>
                        </div>
                    ...
                    <div clas="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div id="card-crear-reserva" class="card card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title">Datos de la Reserva</h3>
                                    </div>
                                    <form action="crear-reserva" id="frm-crear-reserva">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-12 form-group">
                                                    <label for="crear-reserva-Cliente">Seleccione un Cliente:</label>
                                                    <select id="crear-reserva-Cliente" name="cliente" class="form-control select2bs4" style="width: 100%;" required>
                                                        <%
                                                            List<Cliente> clientes = sesion.getAttribute("clientes") == null ? null : (List<Cliente>) sesion.getAttribute("clientes");
                                                            if(clientes != null){
                                                                for(Cliente cliente : clientes){
                                                                    out.print("<option value=\""+ cliente.getId_cliente() +"\">");
                                                                    out.print(cliente.getApellido() + ", " + cliente.getNombre() + " - DNI: " + cliente.getDni());
                                                                    out.print("</option>");
                                                                }
                                                            }
                                                        %>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 form-group">
                                                    <label for="crear-reserva-tipo">Seleccione el tipo:</label>
                                                    <div class="clearfix" id="crear-reserva-tipo">
                                                        <div class="icheck-danger d-inline">
                                                            <input type="radio" name="tipo" id="crear-reserva-tipo-paquete" value="PAQUETE">
                                                            <label for="crear-reserva-tipo-paquete">Paquete</label>
                                                        </div>
                                                        &nbsp;&nbsp;
                                                        <div class="icheck-danger d-inline">
                                                            <input type="radio" name="tipo" id="crear-reserva-tipo-servicio" value="SERVICIO">
                                                            <label for="crear-reserva-tipo-servicio">Servicio</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row" id="seleccionar_paquete" style="display: none">
                                                <div class="col-md-12 form-group">
                                                    <label for="crear-reserva-paquete">Seleccione un Paquete:</label>
                                                    <select id="crear-reserva-paquete" name="paquete" class="form-control select2bs4" style="width: 100%;">
                                                        <%
                                                            List<Paquete> paquetes = sesion.getAttribute("paquetes") == null ? null : (List<Paquete>) sesion.getAttribute("paquetes");
                                                            if(paquetes != null){
                                                                for(Paquete paquete : paquetes){
                                                                    out.print("<option value=\""+ paquete.getId_paquete() +"\">");
                                                                    SimpleDateFormat sfd = new SimpleDateFormat("dd/MM/yyyy HH:mm");
                                                                    String fromFecha = sfd.format(paquete.getFromFecha()) + " hs.";
                                                                    String toFecha = sfd.format(paquete.getToFecha()) + " hs.";
                                                                    out.print(paquete.getNombre() + " - $" + String.format("%.2f", paquete.getPrecio()) + " - Desde: " + fromFecha + " - Hasta: " + toFecha);
                                                                    out.print("</option>");
                                                                }
                                                            }
                                                        %>
                                            ...
                                            <div class="row" id="seleccionar_servicio" style="display: none">
                                                <div class="col-md-12 form-group">
                                                    <label for="crear-reserva-servicio">Seleccione un Servicio:</label>
                                                    <select id="crear-reserva-servicio" name="servicio" class="form-control select2bs4" style="width: 100%;">
                                                        <%
                                                            ...
                                                            if(servicios != null){
                                                                for(Servicio servicio : servicios){
                                                                    ...
                                                                    out.print(servicio.getServicio() + " - " + servicio.getDestino() + " - $" + String.format("%.2f", servicio.getPrecio()) + " - Desde: " + fromFecha + " - Hasta: " + toFecha);
                                                                    out.print("</option>");
                                                                }
                                                            }
                                                        %>
